...
st.title("🧠 Langchain Chatbot") # Changed title here
...
# Removed temperature from session state, as it's no longer user-controlled
...
if load_docs_btn and urls_input:
    ...
    # Removed setting temperature in session state
